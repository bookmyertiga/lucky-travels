export const SITE = {
  ...
  address:
    "No. 9, 4th Cross, Airview Colony, Konena Agrahara, HAL, Bengaluru 560017",
  locality: "Bengaluru",
  region: "Karnataka",
  postalCode: "560017",
  country: "IN",
  googleReviewUrl: "https://g.page/r/Cb6NbUJDpbi2EAE/review",
  specialisationSlogan:
    "Only Premium Ertiga—Because Comfort Should Never Be Optional.",
  instagramUrl: "https://www.instagram.com/gobengaluruwithlucky/",
  facebookUrl: "https://www.facebook.com/gobengaluruwithlucky/",
};
...
export const services: Service[] = [
  {
    ...
    intro:
      "Pre-book a clean Premium Ertiga for airport pickup or airport drop between Kempegowda International Airport and locations across Bengaluru.",
    paragraphs: [
  ...
  },
  {
    ...
    description:
      "Book hourly or daily Premium Ertiga rental packages in Bengaluru for meetings, sightseeing, shopping, events and multiple city stops.",
    short:
      "Flexible Premium Ertiga packages for city travel, meetings and multiple stops.",
    intent:
      "hourly Ertiga rental, daily taxi package, local cab package Bengaluru",
    eyebrow: "Local Bengaluru Rental Packages",
    intro:
      "Choose a Premium Ertiga hourly or daily rental package for local Bengaluru travel with multiple stops and waiting time.",
    paragraphs: [
    ...
    faq: [
      {
        question: "What is an hourly rental package?",
        answer:
          "An hourly package keeps the Premium Ertiga available for an agreed duration and distance, making it suitable for multiple stops and waiting time.",
      },
      {
        question: "Can I book the Ertiga for a full day?",
        answer:
          "Yes. Daily and full-day packages can be discussed based on your pickup point, expected duration and route.",
      },
      {
        question: "Are parking and toll charges included?",
        answer:
          "Inclusions depend on the selected package and route. Lucky Travels confirms parking, toll and any additional charges before booking.",
      },
      {
        question: "Can I use the rental for meetings and city sightseeing?",
        answer:
          "Yes. The service can be booked for meetings, shopping, events, local sightseeing and other multi-stop Bengaluru travel.",
      },
    ],
  },
  {
    ...
    description:
      "Book a Premium Ertiga outstation taxi from Bengaluru for one-way trips, round trips, family travel and multi-day journeys.",
    short:
      "Comfortable one-way and round-trip Premium Ertiga travel from Bengaluru.",
    intent:
      "outstation Ertiga taxi, outstation cab Bengaluru, one-way and round-trip taxi",
    eyebrow: "Travel Beyond Bengaluru",
    intro:
      "Book a Premium Ertiga from Bengaluru for comfortable one-way, round-trip and multi-day outstation journeys.",
    paragraphs: [
    ...
    faq: [
      {
        question: "Do you provide one-way outstation trips?",
        answer:
          "One-way availability depends on the destination and date. Share the route on WhatsApp for confirmation.",
      },
      {
        question: "Can I book a round trip for multiple days?",
        answer:
          "Yes. Round-trip and multi-day travel can be arranged based on vehicle availability and the planned itinerary.",
      },
      {
        question: "Which outstation destinations do you cover?",
        answer:
          "Trips can be planned from Bengaluru to destinations across Karnataka and neighbouring states, subject to route and date availability.",
      },
      {
        question: "What details are needed for a quote?",
        answer:
          "Share the pickup point, destination, travel dates, one-way or round-trip requirement, passenger count and approximate itinerary.",
      },
    ],
  },
];
